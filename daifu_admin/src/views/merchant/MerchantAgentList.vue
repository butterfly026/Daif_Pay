...
import { addMerchantAgent, getMerchantAgentList, editMerchantAgent, deleteMerchantAgent, getCode} from '../../http/apis/merchant';
    ...
    const onSubmit = () => {
      addForm.value.validate(valid => {
        if (valid) {
          ...
          [addMerchantAgent, editMerchantAgent][state.isEdit ? 1 : 0](params).then(res => {
            if (res.status) {
